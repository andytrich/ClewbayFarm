...
GO
CREATE TABLE MushroomEnv (
    Id INT IDENTITY(1,1) PRIMARY KEY, -- Auto-incrementing primary key
    Temperature FLOAT NOT NULL,      -- Temperature in degrees
    Humidity FLOAT NOT NULL,         -- Humidity as a percentage
    CO2Level INT NOT NULL,           -- CO2 level in ppm
    RecordedDateTime DATETIME NOT NULL DEFAULT (GETUTCDATE()) -- UTC time of insertion
);
